        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.pets.index') ? 'active fw-bold' : '' }}" href="{{ route('admin.pets.index') }}">Data Hewan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('owners.index') ? 'active fw-bold' : '' }}" href="{{ route('owners.index') }}">Pemilik</a>
                    </li>
                </ul>
